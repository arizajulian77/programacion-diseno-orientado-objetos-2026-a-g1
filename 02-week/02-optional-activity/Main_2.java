class CuentaBancaria {
    ...
    public static void main(String[] args) {
        ...
        CuentaBancaria cuenta1 = new CuentaBancaria("567-789", 7000);

        System.out.println("Cuenta creada: " + cuenta1.getNumero());
        System.out.println("Saldo inicial: $" + cuenta1.getSaldo());

        // Realizar operaciones
        cuenta1.depositar(4000);   // Depositar dinero
        cuenta1.retirar(7000);     // Retirar dinero
        cuenta1.retirar(5500);     // Intentar retirar más de lo que hay
