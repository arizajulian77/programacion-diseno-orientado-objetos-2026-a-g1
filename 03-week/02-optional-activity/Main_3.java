class Persona {
    ...
    // Métodos
    public void Caminar() {
        System.out.println(nombre + " está caminando en el cementerio.");
    }

    public void Comer() {
        System.out.println(nombre + " está comiendo sandia.");
    }
    ...
    public void Escuchar() {
        System.out.println(nombre + " está escuchando música en spotify.");
    }
    ...
    public static void main(String[] args) {
        ...
        Persona p1 = new Persona("2002", "Eduerdo Romero", 45, 80.5, 1.85, "Masculino");
        Persona p2 = new Persona("2003", "Isabela Rodriguez", 20, 50.2, 1.55, "Femenino");
        Persona p3 = new Persona("2004", "Santiago Pardo", 30, 82.0, 1.90, "Masculino");
